...
from extended_otel_semconv_codegen.registry.model import AttributeDefinition
from extended_otel_semconv_codegen.registry.validation import load_model_registry
from extended_otel_servicegraph_engine.metrics import SERVICE_GRAPH_REQUEST_TOTAL
from extended_otel_servicegraph_engine.observation import EdgeObservation, EntityObservation
from extended_otel_servicegraph_ingest.metrics import parse_metrics_request
from extended_otel_servicegraph_ingest.otlp import any_value_to_python
from extended_otel_servicegraph_ingest.service_graph import observations_from_service_graph_datapoint

CODEGEN_ROOT = (
    Path(__file__).resolve().parents[3] / "packages" / "extended-opentelemetry-semconv-codegen"
)
